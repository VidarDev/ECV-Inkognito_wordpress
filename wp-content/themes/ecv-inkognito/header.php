        ...
        <div class="header__wrapper">
            <div class="header__content">
                ...
                <a class="btn btn--light"
                   aria-label="<?php if (get_field('read-more', 'option')): echo get_field('read-more', 'option'); endif; ?> <?php if (get_field('header__url-label', 'option')): echo get_field('header__url-label', 'option'); endif; ?>"
                   href="<?php if (get_field('header__url', 'option')): echo get_field('header__url', 'option'); endif; ?>">
                    <?php if (get_field('header__url-label', 'option')): echo get_field('header__url-label', 'option'); endif; ?>
                </a>
            </div>
            <a href="#main"
               aria-label="<?php if (get_field('read-more', 'option')): echo get_field('read-more', 'option'); endif; ?>"
               class="header__icon">
                    ...
                    <div class="infos__item">
                        <div>
                            <h2 class="infos__title">
                                <?php if (get_sub_field('information__title', 'option')): echo get_sub_field('information__title', 'option'); endif; ?>
                            </h2>
                            <?php if (get_sub_field('information__content', 'option')): echo get_sub_field('information__content', 'option'); endif; ?>
                        </div>
                    </div>
                <?php endwhile; ?>
            </div>
